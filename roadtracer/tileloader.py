...
tile_dir = '~/Desktop/RoadTracer/data/imagery/'
graph_dir = '~/Desktop/RoadTracer/data/graphs/'
pytiles_path = '~/Desktop/RoadTracer/data/json/pytiles.json'
startlocs_path = '~/Desktop/RoadTracer/data/json/starting_locations.json'
tile_size = 4096
window_size = 512
...
def load_tile(region, i, j, mode='all'):
	...
	sat_im = image.imread(prefix + 'sat.png')
